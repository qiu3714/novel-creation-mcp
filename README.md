...
当前维护版本为 `3.0.0-rc.1` 候选版本。四周维护窗口的交付状态见 [reports/maintenance-closeout-2026-08-24.md](reports/maintenance-closeout-2026-08-24.md)，变更记录见 [CHANGELOG.md](CHANGELOG.md)。治理和来源审计状态见 [reports/governance-audit-2026-08-24.md](reports/governance-audit-2026-08-24.md)，发布验收和社区证据快照见 [reports/release-readiness-2026-08-22.md](reports/release-readiness-2026-08-22.md)。稳定版本将在维护者完成来源风险范围、版本和发布说明决策后另行发布。
